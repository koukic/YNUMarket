class Information < ApplicationRecord
  ...
  CONDITION = {"フリマand教科書" => '教科書',"フリマand本・漫画" => '本・漫画',"フリマandインテリア・家具" => 'インテリア・家具',"フリマandスポーツ" => 'スポーツ',"フリマandその他" => 'フリマ・その他',"サービス" => 'サービス',"サークル・部活andサークル・スポーツ" => 'サークル・スポーツ', "サークル・部活andサークル・文化系"=> 'サークル・文化系', "サークル・部活and部活動"=> '部活動'}
